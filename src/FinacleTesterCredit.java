...
public class FinacleTesterCredit {
	public GenericPackager packager ;
	public ISOMsg m = new ISOMsg();
	
	public FinacleTesterCredit(){
		//System.out.print("Inicio Constructor");
	}
	
	public ArrayList FinacleTestCreditPrepare(String Field2,String Field3,String Field4,String Field11,String Field12,String Field17,String Field24,String Field32,String Field49,String Field102,String Field103,String Field123,String Field125,boolean chkField125,boolean chkAutoAcct,String[] AccountList,int Repeat) throws Exception {
    ...
    //    m.set(102, Field102);
        if (chkAutoAcct){
        	//System.out.println(AccountList[Repeat]);
        	m.set(103, Field103.substring(0,21) + AccountList[Repeat].trim());
        }else{
        	m.set(103, Field103);
        }
        ...
        m.set(123, Field123);
    //    m.set(124, Field124);
       // System.out.println(chkField125);
        if (chkField125){
        	//System.out.println(chkField125);
        	 m.set(125, Field125);
        }
	...
	public ArrayList FinacleTestCreditConnect(String server, int port) throws Exception  {
